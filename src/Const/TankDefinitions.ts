...
export type postAddonId = "dompronounced" | "auto5" | "auto3"  | "autosmasher" | "spike" | "pronounced" | "smasher" | "landmine" | "autoturret" | "weirdspike" | "auto2" | "auto7" | "autorocket" | "spiesk" | "reverseautoturretmachinegun" | "shotgunpronounced" | "homingauto" | "megasmasher"
/** The types of post addons that exist in the game, by their id. */
export type preAddonId = "dombase" | "launcher" | "launcher2"
...
export type projectileId = "bullet" | "drone" | "trap" | "necrodrone" | "minion" | "skimmer" | "rocket" | "swarm" | "flame" | "wall" | "croc" | "homing" | "shotgun" | "lock" | "lockshot" | "slave" | "launched"

/** The types of barrel addons that exist in the game */
export type barrelAddonId = "trapLauncher" | "purplebarrel" | "shotgun" | "lockLauncher";
